...
import logging
from pyspark.sql.functions import col, from_json, current_timestamp, to_timestamp, explode
...
def main():
    ...
    try:
        ...
        kafka_df = (
            ...
            .option("subscribe", "iot-orders-events")
        ...
        transformed_df = (
            ...
            .withColumn("item_count", col("items.product").getItem(0))  # Count items
            .select(
                col("order_id"),
                col("customer_id"),
